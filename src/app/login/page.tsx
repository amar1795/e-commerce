...
useEffect(() => {
  ...
  return (
    <div className=" min-h-screen bg-gradient-to-r from-purple-700 via-pink-700 to-red-700 animate-wave bg-[length:200%_200%] flex justify-center items-center ">
      <div className="min-h-[38rem] w-[70rem] flex justify-center bg-opacity-20 backdrop-blur-lg border-2 border-black bg-white  overflow-hidden below-500:border-none">
        <div className=" relative  w-[30rem] border-r-2 border-black below-600:hidden ">
          <Image
            src="/6.jpg"
            alt="Logo"
            layout="fill"
