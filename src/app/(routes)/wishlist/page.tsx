...
const page = async() => {
  ...
  return (
    <div>
      ...
      <div className=" pt-4">
      <h1 className=" m-4  text-[4rem] leading-none p-2 border-2 border-black text-black flex self-center justify-center border-b-8 border-r-4 bg-yellow-500 uppercase below-835:text-[2rem]">{wishlist.length >0 ? "Your Wishlisted Items":"You have not Wishlisted any items"}
