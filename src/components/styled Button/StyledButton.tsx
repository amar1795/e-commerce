...
const StyledButton = ({buttonName}:StyledButtonProps) => {
  return (
    <button type='submit' id="special-button" className="relative overflow-hidden w-full py-4 text-white  font-bold bg-black group below-700:w-[30rem] below-730:w-[20rem] below-590:w-[18rem] below-460:w-[15rem] below-400:w-[12rem]">
