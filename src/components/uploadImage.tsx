...
export default function UploadImage({ fetchUpdatedImage }) {
  ...
  const CustomAvatar = ({ src }: { src: string }) => (
    <div className="w-24 h-24 below-695:h-16 below-695:w-16 border border-gray-300 rounded-lg overflow-hidden mb-4 below-695:mb-0 ">
      {src ? (
        <Image
          src={src}
          alt="Avatar"
  ...
  return (
    <>
      <Form {...form}>
        ...
        >
          <div className=" below-695:flex below-695:flex-col   below-695:w-[20rem] below-695:justify-between">
            <div className="  below-695:h-[7rem] below-695:flex below-695:flex-col below-695:justify-between"> 
          ...
          <div className="h-[4rem] ">
            <button
              type="submit"
              className="w-[10rem] p-2 border-2 border-black text-black mt-4 
                flex self-center justify-center border-b-8 border-r-4 active:border-b-2 active:border-r-2 bg-pink-500 below-695:text-[0.8rem]"
            >
